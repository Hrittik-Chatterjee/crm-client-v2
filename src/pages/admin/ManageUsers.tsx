    ...
    <div className="space-y-6 mt-2">
      <div className="flex items-center justify-between bg-linear-to-r from-cyan-50 to-teal-50 dark:from-cyan-950/20 dark:to-teal-950/20 p-6 rounded-lg border">
        ...
        <Link to="/admin/add-user">
          <Button className="bg-linear-to-r from-cyan-600 to-teal-600 hover:from-cyan-700 hover:to-teal-700">
            ...
            <div className="flex items-center justify-between px-6 py-4 border-t">
              <div className="flex items-center gap-4">
                ...
                <div className="text-sm text-muted-foreground">
                  Showing {meta ? (page - 1) * meta.limit + 1 : 0} to{" "}
                  {meta ? Math.min(page * meta.limit, meta.total) : 0} of{" "}
                  {meta?.total || 0} users
                </div>
              </div>
